...
execute as @a[nbt={SelectedItem:{id:"minecraft:leather_chestplate",tag:{display:{Name:'{"text":"Backpack"}'}}}}] at @s run tp @e[type=chest_minecart,name=Backpack,distance=..4] ^ ^1 ^
